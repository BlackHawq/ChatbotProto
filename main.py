    ...
    while operational:
      ...
      if choiceBOutPutter == 0:
        print("Ah you've selected option A the name and info option eh? Very well let's get down to business!")
         ...
         print("How strange it appears your option selection has opened a rip in the spacetime contiunum and taken you back to the previous choice!")
         choiceBError = 0
         while choiceBError <2 and choiceBOutPutter > 2:
            choiceBOutPutter
